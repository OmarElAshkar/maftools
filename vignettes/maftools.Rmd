...
<img src="maftools_hex.svg" height="120" style="position:absolute;top:30px;right:0px;" />
...
One can also extract information on drug-gene interactions. For example below is the results for known/reported drugs to interact with DNMT3A. 
